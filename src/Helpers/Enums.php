...
class Enums
{
    ...
    const API_LOG_RESAVENUE_RATE_UPDATE = 'RESAVENUE_RATE_UPDATE';
    const API_LOG_RESAVENUE_INVENTORY_UPDATE = 'RESAVENUE_INVENTORY_UPDATE';
    const API_LOG_RESAVENUE_PROVIDE_INVENTORY = 'RESAVENUE_PROVIDE_INVENTORY';
    const API_LOG_RESAVENUE_PROVIDE_RATES = 'RESAVENUE_PROVIDE_RATES';
    const API_LOG_RESAVENUE_PROVIDE_PROPERTY_CONTENT = 'RESAVENUE_PROVIDE_PROPERTY_CONTENT';
    const API_LOG_RESAVENUE_PROVIDE_BOOKINGS = 'API_LOG_RESAVENUE_PROVIDE_BOOKINGS';
    const API_LOG_RESAVENUE_PUSH_BOOKING = 'API_LOG_RESAVENUE_PUSH_BOOKING';
    const API_LOG_PAYU_MAKE_PAYMENT = 'PAYU_MAKE_PAYMENT';
    const API_LOG_PAYU_PAYMENT_RESPONSE = 'PAYU_PAYMENT_RESPONSE';
    const API_LOG_PAYU_VERIFY_PAYMENT = 'PAYU_VERIFY_PAYMENT';

    const API_LOG_STATUS_SUCCESS = 'SUCCESS';
    const API_LOG_STATUS_PENDING = 'PENDING';
    ...
    const CHANNEL_LOG_TYPE_PROVIDE_PROPERTY_CONTENT = 'PROVIDE_PROPERTY_CONTENT';
    const CHANNEL_LOG_TYPE_PROVIDE_PROPERTY_INVENTORY = 'PROVIDE_PROPERTY_INVENTORY';
    const CHANNEL_LOG_TYPE_UPDATE_PROPERTY_INVENTORY = 'UPDATE_PROPERTY_INVENTORY';
    const CHANNEL_LOG_TYPE_PROVIDE_PROPERTY_RATES = 'PROVIDE_PROPERTY_RATES';
    const CHANNEL_LOG_TYPE_UPDATE_PROPERTY_RATES = 'UPDATE_PROPERTY_RATES';
    const CHANNEL_LOG_TYPE_PUSH_BOOKING = 'PUSH_BOOKING';

    const CHANNEL_LOG_STATUS_PENDING = 'PENDING';
    const CHANNEL_LOG_STATUS_SUCCESS = 'SUCCESS';
    const CHANNEL_LOG_STATUS_FAILED = 'FAILED';
    ...
    const PAYMENT_SERVICE_CASHFREE_PG = 'PG_CASHFREE';
    const PAYMENT_SERVICE_PAYU_PG = 'PG_PAYU';
    ...
    public const SETTLEMENT_TYPE_OTA_PAYABLE = 'OTA_PAYABLE';
    public const SETTLEMENT_TYPE_OTA_COLLECTABLE = 'OTA_COLLECTABLE';

    public const SETTLEMENT_TRANSACTION_TYPE_PAYMENT_TRANSACTION = 'PAYMENT_TRANSACTION';
    public const SETTLEMENT_TRANSACTION_TYPE_OTHER_SETTLEMENT_ADJUSTMENT = 'OTHER_SETTLEMENT_ADJUSTMENT';
