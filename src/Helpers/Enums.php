...
class Enums
{
    const API_LOG_RESAVENUE_BOOKING_PULL_DETAILS = 'RESAVENUE_BOOKING_PULL_DETAILS';
    const API_LOG_RESAVENUE_INVENTORY_FETCH_DETAILS = 'RESAVENUE_INVENTORY_FETCH_DETAILS';
    const API_LOG_RESAVENUE_INVENTORY_UPDATE_DETAILS = 'RESAVENUE_INVENTORY_UPDATE_DETAILS';
    const API_LOG_RESAVENUE_RATE_UPDATE_DETAILS = 'RESAVENUE_RATE_UPDATE_DETAILS';
    const API_LOG_RESAVENUE_RATE_FETCH_DETAILS = 'RESAVENUE_RATE_FETCH_DETAILS';
    const API_LOG_RESAVENUE_PROPERTY_FETCH_DETAILS = 'RESAVENUE_PROPERTY_FETCH_DETAILS';

    const API_LOG_STATUS_SUCCESS = 'SUCCESS';
    const API_LOG_STATUS_FAILED = 'FAILED';

    const HTTP_METHOD_GET = 'GET';
    const HTTP_METHOD_POST = 'POST';

    const API_PAYLOAD_FORMAT_JSON = 'JSON';
    const API_PAYLOAD_FORMAT_XML = 'XML';
