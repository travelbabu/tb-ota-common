...
namespace SYSOTEL\OTA\Common\DB\MongoODM\Documents\BookingSettlement;
 ...
 */
class BookingSettlement extends Document
{
     ...
     * @inheritdoc
     */
    protected string $collection = 'bookingSettlements';
